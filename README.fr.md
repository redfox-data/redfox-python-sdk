...
> **Remarque** : `status` vaut `queued`/`in_progress`/`completed`/`failed` ; seuls les deux derniers sont terminaux (la valeur `processing` de la documentation API n'est jamais renvoyée en pratique).
